<h1 align="center">
  <br>
  <a href="https://github.com/lohithr373/lohithrleo"><img src="https://i.ibb.co/F4HBKqm/TBomb.png" alt="TBomb"></a>
  <br>
  LOHITH v2.1b
  <br>
</h1>
...
- Always ensure that you are using the latest version of LOHITH and have Python 3
...
Install `LOHITH` package by running:
...
>Running `LOHITH.sh` as sudo miscofigures files ownership. It is recommended not to run it as sudo

Run these commands to clone and run LOHITH.
...
git clone https://github.com/lohithr373/lohithrleo.git
cd lohithrleo
./lohithrleo.sh
```
...
- Check **[Avinash](https://github.com/lohith373)** at https://github.com/lohith373
- Mail **[scpketer](https://github.com/lohith373)** at lohithrlohithr373@gmail.com.ch
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/lohithr373/lohithrleo.git) and [PyPi](https://pypi.org/project/tbomb)
##
...
**A:** Try running `sudo pip3 install LOHITH`
##
**Q:** Help, I can't execute LOHITH.sh!
...
For Queries: [Telegram Group](https://t.me/leoooo9380)  
