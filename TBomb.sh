...
banner() {
    ...
    echo -e "\e[1;32m           Telegram: https://t.me/LOHITHChat \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/SpeedXTech \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of LOHITH for more stability."
    echo " "
}
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN LOHITH Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
